...
public class SlidingActivityHelper {
	...
	public enum SlidingActivityBackAction {
		BACK_TO_CONTENT, BACK_TO_MENU, BACK_TO_SECONDARY_MENU
	}

	private SlidingActivityBackAction mBackAction;
	...
	public void onPostCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			boolean open = savedInstanceState
					.getBoolean("SlidingActivityHelper.open");
			boolean secondary = savedInstanceState
